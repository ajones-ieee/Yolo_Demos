...
#model = YOLO("../Yolo_Models/yolov8n-obb.pt")

# Load YOLOv8s-obb model - 
#model = YOLO("../Yolo_Models/yolov8s-obb.pt")

# Load YOLOv8n-obb ncnn model - Works
model = YOLO("/home/rpi5/Desktop/Yolo_Models/obb/NCNN_640/yolov8n-obb_ncnn_model")

# Load YOLOv8s-obb ncnn model - Works
#model = YOLO("../Yolo_Models/yolov8s-obb_ncnn_model")
