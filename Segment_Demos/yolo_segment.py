...
# Load YOLOv8n-seg ncnn model - Does not work. Need to debug.
# RuntimeError: Trying to create tensor with negative dimension -46: [0, -46]
# File "/home/rpi5/yolo_object/lib/python3.11/site-packages/ultralytics/utils/ops.py", line 229, in non_max_suppression
#model = YOLO("yolov8n-seg_ncnn_model")

# Load YOLOv8s-seg ncnn model - Does not work. Need to debug.
# RuntimeError: Trying to create tensor with negative dimension -46: [0, -46]
# File "/home/rpi5/yolo_object/lib/python3.11/site-packages/ultralytics/utils/ops.py", line 229, in non_max_suppression
#model = YOLO("yolov8s-seg_ncnn_model")
